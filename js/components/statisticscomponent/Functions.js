import React from "react"
  ...
  export function graphPieChartAmount(arr,pharma_doc){
   var data_pie=[];
   var arr_color = ["BlueViolet","DarkSeaGreen","DodgerBlue",
  ...
  export function graphPieChart(arr){
   var data_pie=[];
   var arr_color = [
   "#6c87df","DarkGrey","#49a94d","Orange","#d5c965","#f38181",
   "#97c5dd","#eebafa","DeepPink","#d04071","DimGray","DimGrey","DodgerBlue","#2c5dfa","FloralWhite","ForestGreen","#3c3e45","#e2a1ed","#e998b4"];
    ...
    return (
      <div>
        <table className="table table-bordered">
          ...
          <tbody>
            {getMultipleListElements(arr,name1,name2)}
          </tbody>
        </table>
