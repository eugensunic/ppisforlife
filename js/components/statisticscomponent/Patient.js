...
export default class Statistic extends React.Component {
  constructor(props) {
     super(props);
     this.state=({radio3:true, radio4:false, radio5:true, radio6:false, radio7:true, radio8:false, checkbox1:true, change:false,
     button1:true,button2:false,button3:false,button4:false,button5:false,button6:false,button7:false,button8:false,button9:false,
     sending_array_val:[], sending_array_count:[],twenty:false,ten:false,middle_value:false, show_other:false, width:0, clicked_other:false
   });
   }
...
if (this.props.conditionstat.first_stat==undefined  && this.props.conditionppistat.second_stat==undefined  && this.props.sidestat.third_stat==undefined  && this.props.genericstat.fourth_stat==undefined
 && this.props.brandstat.fifth_stat==undefined  && this.props.otherstat.sixth_stat==undefined  && this.props.usedstat.seventh_stat==undefined  && this.props.nutrientstat.eight_stat==undefined  && this.props.naturalstat.nineth_stat==undefined)
 {
   ...
   showPositive(){
     if (this.props.everything.first_other===undefined && this.props.everything.second_other===undefined && this.props.everything.third_other===undefined && this.props.everything.fourth_other===undefined
     && this.props.everything.fifth_other===undefined && this.props.everything.sixth_other===undefined && this.props.everything.seventh_other===undefined && this.props.everything.eight_other===undefined
     && this.props.everything.nineth_other===undefined && this.props.everything.tenth_other===undefined && this.props.everything.eleventh_other===undefined && this.props.everything.twelveth_other===undefined
     && this.props.everything.thirteenth_other===undefined && this.props.everything.fourteenth_other===undefined
     && this.props.everything.third1_other===undefined && this.props.everything.third2_other===undefined && this.props.everything.third3_other===undefined
     && this.props.everything.fifth1_other===undefined && this.props.everything.fifth2_other===undefined
   ){return true}
   else{return false;}
   }
...
console.log("in other"+this.props.everything.first_other);
    if (this.props.everything.first_other && this.props.everything.second_other && this.props.everything.third_other && this.props.everything.fourth_other
    && this.props.everything.fifth_other && this.props.everything.sixth_other && this.props.everything.seventh_other && this.props.everything.eight_other
    && this.props.everything.nineth_other && this.props.everything.tenth_other && this.props.everything.eleventh_other && this.props.everything.twelveth_other
    && this.props.everything.thirteenth_other && this.props.everything.fourteenth_other
    && this.props.everything.third1_other && this.props.everything.third2_other && this.props.everything.third3_other
    && this.props.everything.fifth1_other && this.props.everything.fifth2_other && this.props.everything.fifteenth_other && this.props.everything.sixteenth_other
  )
    {
      return(
        <Otherstats
  ...
  if (this.props.brandstat.first_stat && this.props.conditionppistat.second_stat && this.props.conditionstat.third_stat
        && this.props.genericstat.fourth_stat && this.props.naturalstat.fifth_stat && this.props.nutrientstat.sixth_stat
        && this.props.otherstat.seventh_stat  && this.props.sidestat.eight_stat && this.props.usedstat.nineth_stat
        )
        {
        ...
        <div className="">
          ...
          <div style={{marginBottom:10}}>
            <button type="button" className="btn btn-default" onClick={()=>this.setState({ten:true,twenty:false})}>Show 10</button>
          ...
          <div id="row1" className="row">
            <div className="col-sm-4">
              <Listbox name="Condition initial" order={this.addColumnId(condition_arr)} data={condition_arr} count={this.state.radio7?condition_count_arr:this.valuesToPercentageArray(condition_count_arr)} showmore={this.state.twenty} show_middle={this.state.middle_value}></Listbox>
            </div>
            <div className="col-sm-4">
              <Listbox name="Condition PPI" order={this.addColumnId(conditionppi_arr)} data={conditionppi_arr} count={this.state.radio7?conditionppi_count_arr:this.valuesToPercentageArray(conditionppi_count_arr)} showmore={this.state.twenty}  show_middle={this.state.middle_value}></Listbox>
            </div>
            <div className="col-sm-4">
              <Listbox name="Side effects" order={this.addColumnId(sides_arr)} data={sides_arr} count={this.state.radio7?sides_count_arr:this.valuesToPercentageArray(sides_count_arr)} showmore={this.state.twenty}  show_middle={this.state.middle_value}></Listbox>
            </div>
          </div>
          <div id="row2" className="row">
            <div className="col-sm-4">
              <Listbox name="Generic drug" order={this.addColumnId(generic_arr)} data={generic_arr} count={this.state.radio7?generic_count_arr:this.valuesToPercentageArray(generic_count_arr)} showmore={this.state.twenty}  show_middle={this.state.middle_value}></Listbox>
            </div>
            <div className="col-sm-4">
              <Listbox name="Brand drug" order={this.addColumnId(brand_arr)} data={brand_arr} count={this.state.radio7?brand_count_arr:this.valuesToPercentageArray(brand_count_arr)} showmore={this.state.twenty}  show_middle={this.state.middle_value}></Listbox>
            </div>
            <div className="col-sm-4">
              <Listbox name="Other drugs used" order={this.addColumnId(other_arr)} data={other_arr} count={this.state.radio7?other_count_arr:this.valuesToPercentageArray(other_count_arr)} showmore={this.state.twenty}  show_middle={this.state.middle_value}></Listbox>
            </div>
          </div>
          <div id="row3" className="row">
            <div className="col-sm-4">
              <Listbox name="Used drugs (PPI)" order={this.addColumnId(used_arr)} data={used_arr} count={this.state.radio7?used_count_arr:this.valuesToPercentageArray(used_count_arr)} showmore={this.state.twenty}  show_middle={this.state.middle_value}></Listbox>
            </div>
            <div className="col-sm-4">
              <Listbox name="Nutrients defficiency" order={this.addColumnId(nutrient_arr)} data={nutrient_arr} count={this.state.radio7?nutrient_count_arr:this.valuesToPercentageArray(nutrient_count_arr)} showmore={this.state.twenty} show_middle={this.state.middle_value}> </Listbox>
            </div>
            <div className="col-sm-4">
              <Listbox name="Natural remedies" order={this.addColumnId(natural_arr)} data={natural_arr} count={this.state.radio7?natural_count_arr:this.valuesToPercentageArray(natural_count_arr)} showmore={this.state.twenty}  show_middle={this.state.middle_value}></Listbox>
            </div>
          </div>
          <div className="row bottom-offset">
            <span className={"label label-default inlineblock border_label_span"+(this.state.button1?" highlight_it":"")} onClick={()=>this.setState({button1:true,button2:false,button3:false,button4:false,button5:false,button6:false,button7:false,button8:false,button9:false, sending_array_val:condition_arr,sending_array_count:condition_count_arr})}>condition gastro</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button2?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:true,button3:false,button4:false,button5:false,button6:false,button7:false,button8:false,button9:false, sending_array_val:conditionppi_arr,sending_array_count:conditionppi_count_arr})}>condition ppi</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button3?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:false,button3:true,button4:false,button5:false,button6:false,button7:false,button8:false,button9:false, sending_array_val:sides_arr,sending_array_count:sides_count_arr})}>side effects</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button4?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:false,button3:false,button4:true,button5:false,button6:false,button7:false,button8:false,button9:false, sending_array_val:generic_arr,sending_array_count:generic_count_arr})}>generic</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button5?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:false,button3:false,button4:false,button5:true,button6:false,button7:false,button8:false,button9:false, sending_array_val:brand_arr,sending_array_count:brand_count_arr})}>brand</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button6?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:false,button3:false,button4:false,button5:false,button6:true,button7:false,button8:false,button9:false, sending_array_val:other_arr,sending_array_count:other_count_arr})}>other drug</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button7?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:false,button3:false,button4:false,button5:false,button6:false,button7:true,button8:false,button9:false, sending_array_val:used_arr,sending_array_count:used_count_arr})}>used drugs</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button8?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:false,button3:false,button4:false,button5:false,button6:false,button7:false,button8:true,button9:false, sending_array_val:nutrient_arr,sending_array_count:nutrient_count_arr})}>nutrient defficiency</span>
            <span className={"label label-default inlineblock border_label_span"+(this.state.button9?" highlight_it":"")} onClick={()=>this.setState({button1:false,button2:false,button3:false,button4:false,button5:false,button6:false,button7:false,button8:false,button9:true, sending_array_val:natural_arr,sending_array_count:natural_count_arr})}>natural remedies</span>
          ...
          <button id="buttontarget" type="button" className="btn btn-default" style={{marginTop:5}} onClick={()=>{this.getStatsOtherData();this.setState({clicked_other:true})}}>Other stats</button>
