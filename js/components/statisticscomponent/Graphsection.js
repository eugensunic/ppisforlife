...
export default class Graph extends React.Component {
  ...
  render(){
    ...
    console.log("render width: "+ this.state.width);
    var BarChart;
    var DoughnutChart;
    const canStyle = {
      ...
      <div className="row" ref="get_it">
        {this.props.which_one?
          this.props.percent_value?
            <BarChart style={canStyle}  data={this.graphBar(this.excludeUnknownLabel(this.props.x_arr),this.excludeUnknownValue(this.props.x_arr,this.props.value_arr),this.props.percent_value)} width="800" height="400" redraw/>
          :  <BarChart style={canStyle} data={this.graphBar(this.excludeUnknownLabel(this.props.x_arr),this.valuesToPercentageArray(this.excludeUnknownValue(this.props.x_arr,this.props.value_arr)),this.props.percent_value)} width="800" height="400" redraw/>
          :
          this.props.percent_value?
            <DoughnutChart style={canStyle}  data={this.graphDoughnut(this.excludeUnknownLabel(this.props.x_arr), this.excludeUnknownValue(this.props.x_arr,this.props.value_arr),this.props.percent_value)}  width="800" height="400" redraw/>
            :
          <DoughnutChart style={canStyle}  data={this.graphDoughnut(this.excludeUnknownLabel(this.props.x_arr), this.valuesToPercentageArray(this.excludeUnknownValue(this.props.x_arr,this.props.value_arr)),this.props.percent_value)}  width="800" height="400" redraw/>
