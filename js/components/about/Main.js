        ...
        <div className="row" style={{marginTop:15, marginBottom:10}}>
          <div className="col-sm-6 about_first ">
            ...
            <p>
              ...
              I have a bachelor and master’s degree in transport and traffic science.
            ...
            <p>
              In August 2011, when I was still 19 years of age I’ve been diagnosed with hiatal hernia, GERD 1, gastritis, esophagitis 1 and Barrett’s
              esophagus. Today, I still have (the hiatal hernia which causes problems) this conditions which are managed by PPIs (proton pump inhibitors: omeprazole, esomeprazole, pantoprazole,
              lansoprazole, rabeprazole etc.) on a daily basis (20 mg pantoprazole in the morning).
            </p>
            <p>
          ...
          <div className="col-sm-6">
            <div className="center" style={{marginTop:50}}>
              ...
              <div>
                ...
                <br/>
                <span><b>Condition</b>:hiatal hernia, esophagitis I, Barrett's</span>
                <br/>
                <span><b>Main symptoms</b>:belching/burping, heartburn, pain below ribcage</span>
                <br/>
                <span><b>Therapy</b>:pantoprazole 20mg daily </span>
                <br/>
                <span><b>Exercise</b>:daily </span>
                <br/>
                <span><b>Diet</b>:avoiding sugar, bread, gluten, lactose, no alcohol/smoking/drugs</span>
                <br/>
        ...
        <div className="row">
          <div className="col-sm-6 about_third">
            ...
            <p>
              ...
              to participate in this project, therefore I had to do it on my own. If there is a programmer, doctor, pharmacist or anyone else who thinks that
