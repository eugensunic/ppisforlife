...
export default class Otherdrugs extends React.Component {
  ...
  render(){
    ...
    <div className="output_section_starter">
      <h4 className="overwrite_h4">Other drugs <span className="little-font">(drugs which have similar/same side effects to PPIs)</span></h4>
      <h5>In this section we are trying to see if other popular drugs are related to the problems which PPIs have a connection with</h5>
      <ul>
      ...
      <table className="other_drugs_table">
        <tbody>
          <tr>
            ...
            <td>
              <p className="center"><strong>B12 def.</strong></p>
            </td>
            <td>
              <p  className="center"><strong>Iron def.</strong></p>
            </td>
            <td>
              <p  className="center"><strong>Mg def.</strong></p>
            </td>
            <td>
              <p  className="center"><strong>Osteoporosis</strong></p>
            </td>
            <td>
              <p  className="center"><strong>Heart problems</strong></p>
            </td>
            <td>
              <p  className="center"><strong>Kidney problems</strong></p>
            </td>
            <td>
              <p  className="center"><strong>Cognitive problems</strong></p>
            </td>
      ...
      {/* <p>Condition-Condition</p>
        ...
        <tbody>
          ...
          <tr>
            <td>
              <p className="meds_names">High blood pressure</p>
            </td>
            <td>
              <p>...</p>
            </td>
      ...
      {/* <ul>
        <li>Increase the risk of developing CKD, nephritis 30-36 %</li>
