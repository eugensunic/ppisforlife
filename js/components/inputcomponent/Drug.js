...
export default class Drug extends React.Component {
  constructor(props) {
     ...
     this.state =({first_check:false, duration:[false,false,false,false], daily:[false,false,false],value1:{},value2:{},
     value3:{},value4:{},value1_1:{},value2_2:{},value3_3:{},value4_4:{},brand:"one",generic:"one",input_first:undefined, width:198,red_border:""});
     console.log("START"+this.state.duration)
   }
   updateDimensions(){
 ...
 findAppropriateClassDuration(val){
   ...
   if (val==="first"){return this.props.duration1;}
   if (val==="second"){return this.props.duration2;}
   if (val==="third"){return this.props.duration3;}
   if (val==="fourth"){return this.props.duration4;}
 }
 findAppropriateClassBrand(val){
   if (val==="first"){return this.props.brand1;}
   if (val==="second"){return this.props.brand2;}
   if (val==="third"){return this.props.brand3;}
   if (val==="fourth"){return this.props.brand4;}
 }
 findAppropriateClassBrand2(val){
   if (val==="first"){return this.props.brand12;}
   if (val==="second"){return this.props.brand22;}
   if (val==="third"){return this.props.brand32;}
   if (val==="fourth"){return this.props.brand42;}
 }
 findAppropriateClassGeneric(val){
   if (val==="first"){return this.props.generic1;}
   if (val==="second"){return this.props.generic2;}
   if (val==="third"){return this.props.generic3;}
   if (val==="fourth"){return this.props.generic4;}
 }
 findAppropriateClassDosage(val){
   if (val==="first"){return this.props.dosage1;}
   if (val==="second"){return this.props.dosage2;}
   if (val==="third"){return this.props.dosage3;}
   if (val==="fourth"){return this.props.dosage4;}
  }
 findAppropriateClassGlobaltime(val){
   if (val==="first"){return this.props.globaltime1;}
   if (val==="second"){return this.props.globaltime2;}
   if (val==="third"){return this.props.globaltime3;}
   if (val==="fourth"){return this.props.globaltime4;}
  }
 findAppropriateClassDaily(val){
   if (val==="first"){return this.props.daily1;}
   if (val==="second"){return this.props.daily2;}
   if (val==="third"){return this.props.daily3;}
   if (val==="fourth"){return this.props.daily4;}
  }
  findAppropriateBrand(val){
     if (val==="first"){return this.props.drug.brand1;}
     if (val==="second"){return this.props.drug.brand2;}
     if (val==="third"){return this.props.drug.brand3;}
     if (val==="fourth"){return this.props.drug.brand4;}
  }
  findAppropriateGeneric(val){
    if (val==="first"){return this.props.drug.generic1;}
    if (val==="second"){return this.props.drug.generic2;}
    if (val==="third"){return this.props.drug.generic3;}
    if (val==="fourth"){return this.props.drug.generic4;}
  }
  findRightIndex(val){
    if (val==="first"){return 0;}
    if (val==="second"){return 1;}
    if (val==="third"){return 2;}
    if (val==="fourth"){return 3;}
  }
  ...
  render(){
    var generic_array = ['Esomeprazole', 'Pantoprazole', 'Lansoprazole', 'Dexlansoprazole',
          'Rabeprazole', 'Ilaprazole', 'Tenatoprazole', 'Timoprazole', 'Picoprazole','Omeprazole'
    ];

    var brand_array = ['Nexium','Aciphex', 'Controloc', 'Protonix',
    ...
    <div id="ppi">
      ...
      <div className="col-sm-3 bootstrap_col_modification">
        ...
        <select name="dosage"  className={this.findAppropriateClassDosage(this.props.id)}
          ...
          <option value="" style={{display:'none'}} defaultValue="selected" label="choose dosage"></option>
