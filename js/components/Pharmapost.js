...
export default class Pharmapost extends React.Component {
  ...
  aboutWritting(){
    ...
    <div className="headerbar" style={{marginBottom:6}}>
      <p>This page shows comment posts where users talk about their pharmacist’s giving opinion on the drug, whether the drug is good or not good if taken short-term/long-term. Users express what their pharmacist told them for their therapy. The user associated pharmacist tag refers to this.</p>
      <p>The explicit pharmacist tag refers to pharmacist alone, by themselves expressing their opinion on the drug such as concerns about their long-term usage, dosage etc.</p>
    </div>);
  }
  render() {
  var array_universal=[];
