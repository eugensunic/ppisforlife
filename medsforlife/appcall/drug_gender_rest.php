...
$stmt = $conn->prepare("SELECT post.id, sides.name AS side,  `condition`.name AS  `condition` , conditionppi.name AS ppi_condition, nutrient.name AS nutrient,data.sex
FROM post,  `condition` , post_condition, post_sides, sides, conditionppi, post_conditionppi, nutrient, post_nutrient,data
