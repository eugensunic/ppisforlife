...
FROM post, drug_brand, drug_generic,  `data` , used, used_data, other_drug_data, nutrient, post_nutrient
...
AND nutrient.id = post_nutrient.nutrient 
AND post_nutrient.post = post.id
AND nutrient.name LIKE ?
ORDER BY post.id");
