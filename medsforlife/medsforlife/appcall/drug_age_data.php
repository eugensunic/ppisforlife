...
$stmt = $conn->prepare("SELECT post.id, duration, globaltime_duration, sex, age, dosage, dailyuse, hpylori, drug_generic.name, drug_brand.name, used.name, other_drug_data.other_drug_name
