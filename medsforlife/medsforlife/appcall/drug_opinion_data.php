...
$stmt = $conn->prepare("SELECT post.id, duration, globaltime_duration, sex, age, dosage, dailyuse, hpylori, drug_generic.name AS generic, drug_brand.name AS brand, used.name AS used, other_drug_data.other_drug_name, post.flag
...
$stmt->bind_result($col_1, $col_2, $col_3, $col_4, $col_5, $col_6, $col_7, $col_8, $col_9, $col_10, $col_11, $col_12, $col_13);
while ($stmt->fetch()) {
    $json = array(
        'id' => $col_1,
        'duration' => $col_2,
